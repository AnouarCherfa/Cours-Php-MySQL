<?php
    ...
    //  $requete = $bdd->query('INSERT INTO users(prenom, nom, serie_preferee) 
    //                          VALUES("Nadia", "Aissani", "TF1")');

                    // Modifier un utilisateur

    // $requete = $bdd->query('UPDATE users SET serie_preferee = "Les feux de l\'amour" WHERE prenom = "Nadia"');

                    // Supprimer un utilisateur

    // $requete = $bdd->query('DELETE FROM users WHERE prenom = "Nadia"');
